  ...
  return (
    <section className="py-16">
      <Container className="flex flex-col gap-8">
        <Reveal>
          <h2 className="text-2xl leading-tight">Warum Context Fit?</h2>
        </Reveal>
        ...
        <Reveal
          delay={0.15}
          className="flex flex-col gap-4 text-base leading-relaxed text-text"
        >
          <p>
            ...
            Lebensstil – alles so gestaltet, dass es zu deiner individuellen
            Situation passt. Der Plan orientiert sich an deinem Kontext –
            daher auch der Name: Context Fit.
          </p>
          <p>
            <span className="font-semibold text-text">
              Context Fit: der richtige Ort für vielbeschäftigte Männer und
              Grappling-Athleten.
            </span>{" "}
